          ...
          <div className="grid w-full items-center space-y-4">
            <div className="flex flex-col gap-2">
              ...
              <Input
                ...
                value={username} // Controlled by the username state
            ...
            <div className="flex flex-col gap-2">
              ...
              <Input
                ...
                value={password} // Controlled by the password state
            ...
            >
              ...
              <Input
                ...
                value={confirmPassword} // Controlled by the confirmPassword state
                onChange={(e) => setConfirmPassword(e.target.value)} // Update the confirmPassword state on change
                placeholder="Confirm Password" // Placeholder text
                required={location.pathname === '/register'} // This input is required only if on the register page
              />
              {/* End of TODO 1.5 */}
            </div>
          </div>
